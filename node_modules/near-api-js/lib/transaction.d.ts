...
export declare const functionCall: (methodName: string, args: object | Uint8Array, gas: BN, deposit: BN, stringify?: typeof stringifyJsonOrBytes, jsContract?: boolean) => import("@near-js/transactions").Action;
export declare const functionCallAccessKey: (receiverId: string, methodNames: string[], allowance?: BN) => AccessKey;
export declare const stake: (stake: BN, publicKey: PublicKey) => import("@near-js/transactions").Action;
export declare const transfer: (deposit: BN) => import("@near-js/transactions").Action;
